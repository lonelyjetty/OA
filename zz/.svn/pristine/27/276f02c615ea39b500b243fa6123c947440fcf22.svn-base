...
public class ProductStoriesAndDutiesServiceImpl implements ProductStoriesAndDutiesService {
	...
	public String insertProductStoriesAndDuties(ProductStoriesAndDuties productStoriesAndDuties) {
    	// 获取父元素
    	ProductStoriesAndDuties parentOrganization = productStoriesAndDutiesRepository.findOne(productStoriesAndDuties.getParent());
        // 统一增加新节点层级
	...
	public void deleteProductStoriesAndDuties(String productStoriesAndDutiesId) {
    	...
    	ProductStoriesAndDuties delSysOrganization = productStoriesAndDutiesRepository.findOne(productStoriesAndDutiesId);
        ...
        if (count < 1) {
        	...
        	ProductStoriesAndDuties parentSysOrganization = productStoriesAndDutiesRepository.findOne(delSysOrganization.getParent());
     ...
     * @return List<Organization>
     */
    private List<ProductStoriesAndDuties> getNextLevelOrganization(ProductStoriesAndDuties currentNode, List<ProductStoriesAndDuties> list) {
