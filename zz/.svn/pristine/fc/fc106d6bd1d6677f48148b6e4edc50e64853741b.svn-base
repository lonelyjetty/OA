(function(){
  ...
  now = function(){
    var _ref;
    return (_ref = typeof performance !== "undefined" && performance !== null ? typeof performance.now === "function" ? performance
        .now()
        : void 0
  ...
  Pace.go = function(){
    ...
    return animation = runAnimation(function(frameTime, enqueueNextFrame){
      ...
      for (i = _j = 0, _len1 = sources.length; _j < _len1; i = ++_j) {
        ...
        elements = (_ref2 = source.elements) != null ? _ref2 : [
          source
        ];
