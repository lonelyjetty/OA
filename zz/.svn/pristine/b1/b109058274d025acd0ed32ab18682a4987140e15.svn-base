	...
	return this.each( function() {
		...
		*/
		...
		this.createTableForGroup = function(group, parentgroup) {
			...
			//2016-7-18 sdevil507 modify
			//var th = $("<th colspan='5' align='"+align+"'></th>"); -> $("<th colspan='5' align='"+align+"' style='padding-left:15px;'></th>");
			var th = $("<th colspan='5' align='"+align+"' style='padding-left:15px;'></th>");
			tr.append(th);
